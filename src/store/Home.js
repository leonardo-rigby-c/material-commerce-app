...
class Home extends React.Component {
    ...
    inputSearch(event) {
        ...
        const api = 'http://webdevelopersgdl.com/comercializadora-material/v1/api/search/';
            ...
            <div className="container container-home">
                ...
                <div className="row">
                    <div className="col-md-12 fondo-input">
                        <input type="text" class="form-control"   placeholder="Buscar ..."  value={this.state.buscar} onChange={(event) => this.setState({ buscar: event.target.value })} />
                        <div className="b-icon">
                            <i className="fas fa-search icon-buscador-activo"  onClick={this.inputSearch.bind(this)}></i>
                        </div>
                    </div>
                </div>
                <div className="row products ">
                        ...
                        <div className="row">
                            <div className="col-md-12 div-price">
                                <div className="row">
                                    ...
                                    <div className="col-md-4"><input type="text" class="form-control price" placeholder="00.00" /></div>
                                    <div className="col-md-1">Hasta:</div>
                                    <div className="col-md-4">
                                        <input type="text" class="form-control price" placeholder="00.00" /></div>
                                </div>
                            </div>
                    ...
                    <div className="col-md-9">
                        <div className="row">
                            <h5 id="mensaje-no-data"> ! Upss No se encontraron resultados con " {this.state.buscar} ", Intentente una nueva busqueda ¡</h5>
                            {productos.map(item => (
                                <div key={item.id} className="col-md-2 card">
                                    <i className="fas fa-plus "  onClick={this.addCarrito.bind(this)}></i>
